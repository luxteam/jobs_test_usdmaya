...
"C:\Program Files\Autodesk\Maya%TOOL%\bin\maya.exe" -command "python(\"import cache_building\")" -file "C:\\TestResources\\usd_maya_autotests_assets\\Scenes\\USD_Material.ma"
